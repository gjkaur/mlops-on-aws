"""
SageMaker Training entry: train RandomForest, persist model.joblib and metrics.json (Lab 8).
"""
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("CAPSTONE STEP 2: TRAINING MODEL")
    print("=" * 50)
    print(
    ...
    print(f"Test channel: {X_test.shape}")
    ...
    print("Model performance (test channel holdout):")
